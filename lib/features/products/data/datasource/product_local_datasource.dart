...
class ProductLocalDataSourceImpl implements ProductLocalDataSource {
  static final List<ProductEntity> _products = [
    ...
    const ProductModel(
      ...
      category: 'Fashion',
      imageUrl:
          'https://lh3.googleusercontent.com/aida-public/AB6AXuANytd12XUjx3TxsgUVjP_C8TbxM6SgHfxx_tDEnOf-Y39YLEYlHcS2npcKEFg84lSv3IT3MLVX9ehTAm6p9Q1nLYYvJKn3NzLzQ2KXZSU50TPVngrrQJB6vBlVLSMEkIU2KDdFUv0tIxA_19lRO6zDnA1Oyej94NVfuCIzo9IALF-78xBtOTr2GfN-hT89atCQxdfUCa7iDK0wC0Dtsl-fBQ3mtM_AvyEzvF1_M_3ohPOxRnUXrltG_lIwwmnjkcVt0lkBc_Gw1g',
      price: 2450.00,
      ...
      tag: 'Limited Edition',
      description:
          'Crafted from sustainably sourced grain de poudre leather, the Aurelia Tote features iconic gold-tone hardware and a spacious interior lined with organic silk. A timeless masterpiece designed for the modern connoisseur.',
      images: [
      ...
      reviews: [
        ProductReviewModel(
          ...
          rating: 5.0,
          comment:
              'Incredible craftsmanship and finish. A timeless addition to any collection.',
          date: '3 days ago',
        ),
      ],
      storeAvailability: [
        StoreAvailabilityModel(
          ...
          logoUrl:
              'https://lh3.googleusercontent.com/aida-public/AB6AXuCwuA4cyqLK4AfTsJKV0agKXaA0nTDJ1q4ZJAn33pwuTVh5GhsfS5SNQYwDuUQMe0tbn2vmKMaQEYipKLOgtHuweHI8qtsDtC0kZqr3VTy8xAq5Ze9Jio0fwhSM5dgdFJaI3KIKfnyf-3_p0ALmYC7H6AokbTnvojDWevvYZwJf-B7H13mVj6RQ0oz5iTkn1TXr2EP5mCXop8UmR5svm78mQtuqtNsE9furD3OaZk-KFWTZrQGMEvnWdmPVvhBTKMxxIf-wT9Erxw',
          floorText: 'Level 2',
    ...
    const ProductModel(
      ...
      imageUrl:
          'https://lh3.googleusercontent.com/aida-public/AB6AXuBvM69bKCVyq8_NfztOI3H6tftHjtAvZNuCR37MCubOVKldUv8hT4PopJuxYag_kM4Dbtq11fMB_GGv3ZIHTk0QgQJH7NH8pcwfh7UlwiGiozm_4rcqRknOy4PiLPNr3wHSHeNrDQz_ljJUDtXCjQpn9v-IJ51P-gZFAeqnO5FMC4tJJWhbZHozy1pqtv6ctBdpBksb1QFjFGH-VFplvstsT2hrfnBGeAvfiQumcyPrTMzgZH5qQpbSwCVHwerV19h-aw-PJiloiQ',
      price: 8450.00,
      rating: 4.8,
      floorText: 'Level 1',
      inStock: true,
      ...
      tag: 'Limited Edition',
      description:
          'A masterpiece of precision engineering and ultra-thin watch design. Housed in a polished stainless steel case and paired with a genuine alligator leather strap.',
      images: [],
      specifications: [],
      reviews: [],
      storeAvailability: [],
    ...
    const ProductModel(
      ...
      tag: 'New Arrival',
      description:
          'High-fashion modern designer sneakers constructed with premium leather panels, breathable mesh base, and architectural layered outsole structures.',
      images: [],
      specifications: [],
      reviews: [],
      storeAvailability: [],
    ...
    const ProductModel(
      ...
      tag: 'Trending Now',
      description:
          'A premium fragrance housed in a beautifully decorated lacquered bottle. Dominated by sweet floral notes and fresh accents of pear blossom.',
      images: [],
      specifications: [],
      reviews: [],
      storeAvailability: [],
    ...
    const ProductModel(
      ...
      tag: 'Trending Now',
      description:
          'Premium over-ear headphones combining high-fidelity audio with industry-leading Active Noise Cancellation and spatial audio tracking.',
      images: [],
      specifications: [],
      reviews: [],
      storeAvailability: [],
    ...
    const ProductModel(
      ...
      category: 'Fashion',
      imageUrl:
          'https://lh3.googleusercontent.com/aida-public/AB6AXuABC7y2H1IXMFV9A0s7gTn7w6p82_PZA5YXfWnXg-PjdkiLuCHkqtt_bKqpLe9FpLeiMX8ou9OnRRWAlxJ9NMGRzFM4fiBqny6V5IaO1rlJL6KXvSRGDac-PYTymj4Fm1p4nrk4xBABkicqUDOdfUBhZunX5Jve4CoAQq5VxEOJT1gTJnj9IF51pISvvfXiGH2-Nuouw6M5NmVtd5P6hdPxtleqSlLu6zE_TI8ofsHaIM7X-k9j6Am8q50pbBOur54xXdCC0AfFkQ',
      price: 3200.00,
      rating: 5.0,
      floorText: 'Level 2',
      inStock: true,
      ...
      tag: 'Trending Now',
      description:
          'Classically structured top-handle bag constructed with Prada\'s iconic scratch-resistant Saffiano cross-hatched calf leather.',
      images: [],
      specifications: [],
      reviews: [],
      storeAvailability: [],
    ...
    const ProductModel(
      ...
      category: 'Electronics',
      imageUrl:
          'https://lh3.googleusercontent.com/aida-public/AB6AXuCm-ooWXuh6GbuUxWBgphcWZEwKxwSuIdgsrIHcsPXefxN50wLMsP5Vp2L9AKdp3n1vkfh2puJbBeOcRKbFx4Yr0YDJ59VAc3Wrl12g-Hz8jZ9mhcH4_EAevbsBecDEDNrtWLCmwLfxQkRk97eb69xvk8kqviKyXX8gT-0M0YlVPZJjHaCpn8UHM1P2bZL8ObsyZpnXQjhvFhqNPPkhXOL5DYx_ZXRmfUR6BkBkwov9ooN4andcX82McJhEclxO5-O0G719Mgts0Q',
      price: 399.00,
      rating: 4.7,
      floorText: 'Level 2',
      inStock: true,
      ...
      tag: 'In Stock',
      description:
          'Sony WH-1000XM5 noise-canceling headphones with dual processors controlling eight microphones, Auto NC Optimizer, and high-quality phone calls.',
      images: [],
      specifications: [],
      reviews: [],
      storeAvailability: [],
    ...
    const ProductModel(
      ...
      category: 'Fashion',
      imageUrl:
          'https://lh3.googleusercontent.com/aida-public/AB6AXuByywbviD82po09UFshh3-jY0SK1zzoTFQd4afRJQSptcGIpR71xxbzOSpz1dzpg5kx70zuNjbLm3METZj7MseKCMKkVAqjSFylK97bkuD_nbuBzVSilgywQJ5XNPsoN6EFB3Xg5KHDtQng2g6MWSwjxgI9jl2iBSTxpu2SiOa3htOoqnJObmh0P-kk7zLjE7CxSRitWm2RTMJLN90z5MXxaSYlYr3LN96tMMXyij5pF9a4CPu3MKzViiT1ZQvgC-as7En1g2vyNg',
      price: 485.00,
      rating: 4.6,
      floorText: 'Level 1',
      inStock: true,
      ...
      tag: 'In Stock',
      description:
          'An elegant Hermès accessory made of pure silk showcasing detailed botanical motifs and hand-rolled edge linings.',
      images: [],
      specifications: [],
      reviews: [],
      storeAvailability: [],
    ...
    const ProductModel(
      ...
      tag: 'In Stock',
      description:
          'Hermès luxury beige leather shoulder bag with sleek metallic lock accent.',
      images: [],
      specifications: [],
      reviews: [],
      storeAvailability: [],
    ...
    const ProductModel(
      ...
      category: 'Fashion',
      imageUrl:
          'https://lh3.googleusercontent.com/aida-public/AB6AXuB1o0Acou-eiqylStJTsvWqgmkWUwcZJK-CeE7tgoKgIbiaADkUAF6mVhLqAUkcq8_EPe_5UOPUtn3kB7XM5DKs1x9eIHu54DZ_xT-EHbpyWCd2Vv3IS18cYJ-WmSnD_jKJ1qkWTH0MhQThcfqsLqde_gk34cSZ1qcdbW1BGoC4F-dbuKQDtoZbuvvEnkUYhBKCrj0qOxL_kQIFAnjnkK1YwvpSWNB--7mLycECg5MiVm9v3d1KvSQ7q9TEjXDt3pxyt-Xo4nVs2w',
      price: 1250.00,
      rating: 4.9,
      floorText: 'Level 2',
      inStock: true,
      ...
      tag: 'In Stock',
      description:
          'Sophisticated black quilted leather clutch featuring classic Saint Laurent design features.',
      images: [],
      specifications: [],
      reviews: [],
      storeAvailability: [],
    ...
    const ProductModel(
      ...
      category: 'Fashion',
      imageUrl:
          'https://lh3.googleusercontent.com/aida-public/AB6AXuBKHS8gE8CXlXz6iodm47i2GXmqc9Liiqxa9UoeL4n9uGgXa-z8oq79u3mpp7UL23dzGyljIWUTmEgft9KyEuAkTJnHWQaMR9PwD_ubrejJ9LjmL-GIgMwn99a2GtRk7mSB7QkS3uvOqUdbEtRgiHn68z_FozZOMD00__jukYxlXMyvrHVZQg_7sH1NBL_AVH_3wMhnh0Vl0QWik9wJzW1O-r6eyG9ZaPXjkBoLqKc-Gb5p8UAyo45kUyIcnxtW3SulTBqBT58n5w',
      price: 2100.00,
      rating: 4.8,
      floorText: 'Level 2',
      inStock: true,
      ...
      tag: 'In Stock',
      description:
          'Elegant white top-handle tote featuring architectural silhouettes and gold fittings.',
      images: [],
      specifications: [],
      reviews: [],
      storeAvailability: [],
