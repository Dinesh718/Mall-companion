                          ...
                          children: [
                            ...
                            TextField(
                              decoration: InputDecoration(
                                hintText: 'Search services, facilities or info...',
                            ...
                            GestureDetector(
                              onTap: () {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  const SnackBar(content: Text('Connecting to Concierge Desk...')),
                                );
                              },
                              child: Container(
                                height: 180.0,
                                    ...
                                    onTap: () {
                                      if (action.type == 'parking') {
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                            builder: (_) => const ParkingDetailsPage(),
                                          ),
                                        );
                                        ...
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                            builder: (_) => const AmenitiesDetailsPage(),
                                          ),
                                        );
                            ...
                            Column(
                              children: [
                                ...
                                MallServiceBentoCard(
                                  service: state.mallServices.firstWhere((s) => s.id == 'directory'),
                                  isLarge: true,
                                  onTap: () {},
                                ),
                                  ...
                                  children: [
                                    Expanded(
                                      child: MallServiceBentoCard(
                                        service: state.mallServices.firstWhere((s) => s.id == 'parking_availability'),
                                        onTap: () {
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                    ...
                                    Expanded(
                                      child: MallServiceBentoCard(
                                        service: state.mallServices.firstWhere((s) => s.id == 'amenities_dir'),
                                        onTap: () {
                                          Navigator.push(
                                            context,
                                            MaterialPageRoute(
                                ...
                                Row(
                                  children: [
                                    Expanded(
                                      child: MallServiceBentoCard(
                                        service: state.mallServices.firstWhere((s) => s.id == 'offers_hub'),
                                        onTap: () {},
                                      ),
                                    ),
                                    const SizedBox(width: 16.0),
                                    Expanded(
                                      child: MallServiceBentoCard(
                                        service: state.mallServices.firstWhere((s) => s.id == 'gift_cards'),
                                        onTap: () {},
                                      ),
                                    ),
                                  ],
                            ...
                            PopularServicesSection(
                              ...
                              onItemTap: (service) {
                                ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(content: Text('Connected to ${service.title}')),
                                );
                              },
                            ),
                            const SizedBox(height: 32.0),
                            ...
                            FeedbackBentoCard(
                              onSubmit: (stars, comments) {
                                context.read<MoreBloc>().add(SubmitUserFeedback(rating: stars, comments: comments));
                              },
          ...
          actions: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(content: Text('Mock security call connected.')),
                );
              },
